...
class OpenSearchSinkConfig extends LitMvvmElement {
  isValid() {
...
window.customElements.define('opensearch-sink-config', OpenSearchSinkConfig);

const tag = model => html`<opensearch-sink-config .model=${model}></opensearch-sink-config>`;
