...
input[type="checkbox"].kds-checkbox {
  width: 1.2rem;
  height: 1.2rem;
...
input[type="checkbox"].kds-checkbox:active {
  background-color: #ddd;
}

input[type="checkbox"].kds-checkbox:focus {
  box-shadow: 0 0 0 2px rgba(66, 153, 225, 0.5);
}

input[type="checkbox"].kds-checkbox:checked {
  background-size: cover;
}

input[type="checkbox"].kds-checkbox:disabled {
